...
class Agente_YeisonOsorio_AlejandraPerez:

    #def agente(estado, jugador):

    #def obtenerDireccion(self, estado):
        # NORTE
        # SUR
        # ESTE
        # OESTE
...
def minimax_decision(estado, game):
...
#Agente_YeisonOsorio_AlejandraPerez()
